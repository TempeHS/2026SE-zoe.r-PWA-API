...
Students can create files as they are needed. This structure defines the correct directory structure for all files. As students `𝓽𝓸𝓾𝓬𝓱` each file, they should refer to this structure to ensure the file path is correct.
